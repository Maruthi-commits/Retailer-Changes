package com.Retail.Retailer.ControllerTest;
...
import com.Retail.Retailer.Controller.RetailerController;
	   ...
	   @Test
	    public void testCalculateRewards_EmptyTransactions() throws Exception {
	        ...
	        mockMvc.perform(post("/api/rewards/calculate")
	                        ...
	                        .content(objectMapper.writeValueAsString(emptyTransactions)))
	                .andExpect(status().isBadRequest()) // Expecting 400 Bad Request due to empty list
	                .andDo(print());
	    }
